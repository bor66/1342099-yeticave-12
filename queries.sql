...
INSERT INTO lots (name, add_date, description, image_link, start_price, expiration_date, step_sum, author_id, winner_id, category_id) 
VALUES ('DC Ply Mens 2016/2017 Snowboard', '2020-05-15 12:10:40', 'Один из лучших сноубордов в своем классе', 'img/lot-2.jpg', 159999, '2020-06-15 12:00:00', 1000, 2, 2, 1);
INSERT INTO lots (name, add_date, description, image_link, start_price, expiration_date, step_sum, author_id, winner_id, category_id) 
VALUES ('Крепления Union Contact Pro 2015 года размер L/XL', '2020-05-30 10:59:30', 'Надежные крепления', 'img/lot-3.jpg', 8000, '2020-06-23 15:00:00', 200, 3, 3, 2);
INSERT INTO lots (name, add_date, description, image_link, start_price, expiration_date, step_sum, author_id, winner_id, category_id) 
VALUES ('Ботинки для сноуборда DC Mutiny Charocal', '2020-06-01 00:00:30', 'Удобные ботинки', 'img/lot-4.jpg', 10999, '2020-06-25 20:30:00', 300, 1, 1, 3);
INSERT INTO lots (name, add_date, description, image_link, start_price, expiration_date, step_sum, author_id, winner_id, category_id)
VALUES ('Куртка для сноуборда DC Mutiny Charocal', '2020-06-03 18:09:34', 'Теплая и лёгкая куртка', 'img/lot-5.jpg', 7500, '2020-07-10 00:00:00', 200, 3, 3, 4);
INSERT INTO lots (name, add_date, description, image_link, start_price, expiration_date, step_sum, author_id, winner_id, category_id)
...
SELECT l.name, l.start_price, l.image_link, b.sum_price, c.name FROM lots l JOIN categories c ON c.id = l.category_id
...
SELECT name FROM lots WHERE id = 1;

-- обновить название лота по его идентификатору
UPDATE lots SET name = 'Крепления Union Contact Pro 2015 года размер M/XXL' WHERE id = 3;

-- получить список ставок для лота по его идентификатору с сортировкой по дате
SELECT b.lot_id FROM bet b JOIN lots l ON b.lot_id = l.id WHERE l.id = 1 ORDER b.bet_date DESC;
