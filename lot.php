...
$sql_lot = "SELECT l.id, l.name, l.add_date,  l.description, l.image_link, l.start_price, l.expiration_date, l.step_sum, b.sum_price, c.name category FROM lots l JOIN categories c ON c.id = l.category_id LEFT JOIN bet b ON b.lot_id = l.id WHERE l.id = '$lot_id'";
$result_lots = mysqli_query($con, $sql_lot);
...
$sql_bet = "SELECT b.bet_date, b.sum_price, b.user_id, b.lot_id, u.name FROM bet b JOIN users u ON b.id = u.id WHERE l.id = '$lot_id'";
